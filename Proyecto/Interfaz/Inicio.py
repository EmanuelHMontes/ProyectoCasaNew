...
class LoginWindow(QMainWindow, Ui_LoginWindow):
    ...
    def resizeEvent(self, event):
        ...
        pixmap = QPixmap("/home/Emanuel/Desktop/Casa/ProyectoCasa/Proyecto/imag/casa real.jpg")  # Ruta de la imagen de fondo
...
class MenuWindow(QMainWindow, Ui_MenuWindow):
    ...
    def resizeEvent(self, event):
        # imagen de fondo coincida con la prinicipal 
        pixmap = QPixmap("/home/Emanuel/Desktop/Casa/ProyectoCasa/Proyecto/imag/Casain.jpg")  # Ruta de la imagen de fondo
        self.label_background.setPixmap(pixmap.scaled(self.size()))  # Escala la imagen para que se ajuste al tamaño de la ventana
...
class CocinotaWindow(QMainWindow, Ui_Cocina):
    ...
    def encenderLED(self):
        # Enciende el LED
        GPIO.output(LED_PINC, GPIO.HIGH)

    def apagarLED(self):
        # Apaga el LED
        GPIO.output(LED_PINC, GPIO.LOW)
...
class HabitacionWindow(QMainWindow, Ui_Habitacion):
    ...
    def encenderLED(self):
        # Enciende el LED
        GPIO.output(LED_PINH, GPIO.HIGH)

    def apagarLED(self):
        # Apaga el LED
        GPIO.output(LED_PINH, GPIO.LOW)
...
class SalaWindow(QMainWindow, Ui_Sala):
    ...
    def encenderLED2(self):
        # Enciende el LED
        GPIO.output(LED_PINS2, GPIO.HIGH)
    ...
    def apagarLED2(self):
        # Apaga el LED
        GPIO.output(LED_PINS2, GPIO.LOW)
